  ...
  return (
    <div className="header-bg">
      <div className="dashboard-content-wrapper">
        ...
        Organize and improve your studying with our spaced repetition web app!
        {/* - create flashcards, rate difficulty, and let our app optimize your learning experience. */}
        ...
        <Button className='button-header' onClick={() => navigate(`/create`)}>Create New Deck</Button>
      </div>
    </div>
  );
}
